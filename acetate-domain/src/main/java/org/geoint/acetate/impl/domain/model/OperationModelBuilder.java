...
public interface OperationModelBuilder {
     ...
     */
    OperationModelBuilder withParameter(String paramName, ObjectId paramModel)
     ...
     * @return this builder
     */
    OperationModelBuilder withReturn(ObjectId returnModel);
     ...
     * @return this builder
     */
    OperationModelBuilder withException(ObjectId exceptionModel);
