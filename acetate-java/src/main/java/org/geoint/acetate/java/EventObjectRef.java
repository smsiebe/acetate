 ...
 * @param <T> java type representing the domain event
 */
public interface EventObjectRef<T> extends InstanceRef<EventObject<T>> {

    @Override
    public NamedTypeRef<EventClass<T>> getRefModel();
