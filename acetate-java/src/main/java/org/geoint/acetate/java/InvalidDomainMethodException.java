...
public class InvalidDomainMethodException extends InvalidModelException {
    ...
    public InvalidDomainMethodException(TypeModel domainType,
            Class<?> resourceClass, Method operationMethod) {
        this(domainType.getDomainNamespace(), domainType.getDomainType(),
                domainType.getDomainVersion(), resourceClass, operationMethod);
    }
