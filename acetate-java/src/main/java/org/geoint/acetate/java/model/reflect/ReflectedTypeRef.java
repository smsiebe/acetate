...
public class ReflectedTypeRef<T extends TypeClass> implements TypeClassRef<T> {
    ...
    protected static ReflectedTypeRef<ReflectedMapClass> mapReference(
            String refName, String refDesc, Type type)
            throws InvalidModelException {
        
        //TODO support annotation to override the key/value metadata
        ReflectedTypeRef<?> keyRef 
                = ReflectedTypeRef.typeReference("key", 
                        "", 
                        ReflectUtil.getMapKeyClass(type));
        ReflectedTypeRef<?> valueRef
                = ReflectedTypeRef.typeReference("value", 
                        "", 
                        ReflectUtil.getMapValueClass(type));
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.referencedModel, other.referencedModel)) {
            return false;
        }
        return true;
    }
