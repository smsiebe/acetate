...
public final class ComponentFilters {
    ...
    /**
     * Determines if the domain component is locally defined based on the
     ...
     * composite)
     */
    public static boolean isLocal(DomainComponent<?> component) {
    ...
    /**
     * Determines if the domain component is defined by a composite component of
     * its object model.
     *
     * This method is designed to be used as a method reference by implementing
     * the {@link Predicate} signature.
     ...
     * object
     */
    public static boolean isComposite(DomainComponent<?> component) {
     ...
     */
    public static boolean isInherited(DomainComponent<?> component) {
